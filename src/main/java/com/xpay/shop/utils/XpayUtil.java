...
public class XpayUtil {
	 ...
	 * @throws Exception
	 */
	public static String sign(TreeMap<String,Object> params,String appkey){
	 ...
	 public static boolean validSign(TreeMap<String,Object> param,String appkey){
